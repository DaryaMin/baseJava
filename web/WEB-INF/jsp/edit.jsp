...
<%@ page import="com.uirise.webapp.model.SectionType" %>
<%@ page import="com.uirise.webapp.util.DateUtil" %>
            ...
            <c:choose>
                ...
                <c:when test="${type=='QUALIFICATIONS' || type=='ACHIEVEMENT'}">
                    <textarea name='${type}' cols=75
                              rows=5> <%=((ListSection) section).getList()%></textarea>
                </c:when>
                    ...
                    <c:forEach var="org" items="<%=((OrganizationSection) section).getOrganizations()%>"
                        ...
                        <div style="margin-left: 30px">
                            <c:forEach var="pos" items="${org.positions}">
                                <jsp:useBean id="pos" type="com.uirise.webapp.model.Organization.Position"/>
                                <dl>
